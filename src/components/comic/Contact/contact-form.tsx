      ...
      <form onSubmit={onSubmit} className="space-y-6">
        <div className="relative">
          <input
            ...
            className="w-full rounded-lg border-4 bg-white p-4 text-lg font-semibold text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-4"
            style={{
          ...
          />
          {nameError && (
            <p id="contact-name-error" className="mt-2 text-sm font-semibold text-red-700">
              {nameError}
            </p>
          )}
        </div>
        ...
        <div className="relative">
          ...
          />
          {emailError && (
            <p id="contact-email-error" className="mt-2 text-sm font-semibold text-red-700">
              {emailError}
            </p>
          )}
        </div>
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full resize-none rounded-lg border-4 bg-white p-4 text-lg font-semibold text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-4"
            style={{
              borderColor: messageError ? GOOGLE_COLORS.red : GOOGLE_COLORS.green,
              boxShadow: "4px 4px 0px #000",
            }}
          />
          {messageError && (
            <p id="contact-message-error" className="mt-2 text-sm font-semibold text-red-700">
              {messageError}
            </p>
          )}
        </div>
